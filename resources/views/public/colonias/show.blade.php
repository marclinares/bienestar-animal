            ...
            <form action="{{ route('contacto.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="relative group">
                        <input type="text" name="telefono" placeholder="Teléfono (opcional)" class="w-full bg-white border-0 rounded-xl p-4 focus:ring-2 focus:ring-coral outline-none text-sm">
                ...
                <textarea name="mensaje" placeholder="¿Por qué quieres adoptar o qué información necesitas?" rows="3" class="w-full bg-white border-0 rounded-xl p-4 focus:ring-2 focus:ring-coral outline-none text-sm mt-2" required></textarea>
                
                <div class="pt-4">
                    <button type="submit" class="w-full bg-marron text-cremaClaro py-4 rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-chocolate transition-all shadow-xl">
                        Enviar solicitud
                    </button>
                </div>
            </form>
